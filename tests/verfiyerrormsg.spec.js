...
test("Verify Error Message", async function ({ page }) {
  ...
  await page
    ...
    .type("123@gmail.com", { delay: 200 });
  await page
    .getByPlaceholder("Enter Password")
    .type("playwright@1234", { delay: 200 });
